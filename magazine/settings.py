...
PROJECT_DIR = SETTING_DIR

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'automag.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'd4-8^5&amp;1)noao&amp;#0k#$iw6nay9v%+ldg^@sc^q%k-b5jam*6zj'
