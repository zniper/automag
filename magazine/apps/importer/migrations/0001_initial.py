...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('importer_importproxy', (
            ...
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Article'], null=True, on_delete=models.SET_NULL, blank=True)),
    ...
    models = {
        ...
        'importer.importproxy': {
            ...
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['content.Article']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
