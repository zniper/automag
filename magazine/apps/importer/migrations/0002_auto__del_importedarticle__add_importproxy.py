...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('importer_importedarticle')

        # Adding model 'ImportProxy'
        db.create_table('importer_importproxy', (
            ...
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Article'], null=True, blank=True)),
            ('import_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True)),
            ('local_path', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('importer', ['ImportProxy'])


    def backwards(self, orm):
        # Adding model 'ImportedArticle'
        db.create_table('importer_importedarticle', (
            ('uid', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('local_path', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Article'], null=True, blank=True)),
        ...
        db.send_create_signal('importer', ['ImportedArticle'])

        # Deleting model 'ImportProxy'
        db.delete_table('importer_importproxy')
    ...
    models = {
        ...
        'importer.importproxy': {
            'Meta': {'object_name': 'ImportProxy'},
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['content.Article']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
