...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportProxy.url'
        db.alter_column('importer_importproxy', 'url', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'ImportProxy.url'
        db.alter_column('importer_importproxy', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=256))
