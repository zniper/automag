...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SingleImage.date'
        db.delete_column('content_singleimage', 'date')

        # Adding field 'SingleImage.publish_date'
        db.add_column('content_singleimage', 'publish_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 30, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SingleImage.date'
        db.add_column('content_singleimage', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SingleImage.publish_date'
        db.delete_column('content_singleimage', 'publish_date')
    ...
    models = {
        ...
        'content.singleimage': {
            ...
            'publish_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 30, 0, 0)'}),
