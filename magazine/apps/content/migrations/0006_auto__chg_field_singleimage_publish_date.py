...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SingleImage.publish_date'
        db.alter_column('content_singleimage', 'publish_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'SingleImage.publish_date'
        db.alter_column('content_singleimage', 'publish_date', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        'content.singleimage': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 30, 0, 0)'}),
