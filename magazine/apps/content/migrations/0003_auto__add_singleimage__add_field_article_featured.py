...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SingleImage'
        db.create_table('content_singleimage', (
        ...
        db.send_create_signal('content', ['SingleImage'])

        # Adding field 'Article.featured'
        db.add_column('content_article', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SingleImage'
        db.delete_table('content_singleimage')

        # Deleting field 'Article.featured'
        db.delete_column('content_article', 'featured')
