...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SingleImage.attachment'
        db.delete_column('content_singleimage', 'attachment')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SingleImage.attachment'
        raise RuntimeError("Cannot reverse this migration. 'SingleImage.attachment' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SingleImage.attachment'
        db.add_column('content_singleimage', 'attachment',
