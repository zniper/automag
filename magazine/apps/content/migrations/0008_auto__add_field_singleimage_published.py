...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SingleImage.published'
        db.add_column('content_singleimage', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SingleImage.published'
        db.delete_column('content_singleimage', 'published')
